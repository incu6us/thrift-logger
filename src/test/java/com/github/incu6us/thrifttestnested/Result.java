...
public class Result implements org.apache.thrift.TBase<Result, Result._Fields>, java.io.Serializable, Cloneable, Comparable<Result> {
    ...
    static {
        ...
        tmpMap.put(_Fields.NESTED, new org.apache.thrift.meta_data.FieldMetaData("nested", org.apache.thrift.TFieldRequirementType.DEFAULT,
                new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, NestedResult.class)));
    ...
    public Result(Result other) {
        ...
        if (other.isSetNested()) {
            this.nested = new NestedResult(other.nested);
        }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public NestedResult getNested() {
        return this.nested;
    }

    public Result setNested(@org.apache.thrift.annotation.Nullable NestedResult nested) {
        this.nested = nested;
        return this;
    }
    ...
    public int compareTo(Result other) {
        ...
        lastComparison = Boolean.compare(isSetNested(), other.isSetNested());
        if (lastComparison != 0) {
            return lastComparison;
        }
        if (isSetNested()) {
                ...
                switch (schemeField.id) {
                    ...
                    case 3: // NESTED
                        if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                            struct.nested = new NestedResult();
